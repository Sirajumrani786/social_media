            ...
            <form action="#">
              <div className="row">
                <div className="col-lg-6 mb-3">
                  <div className="form-group">
                    <label className="mont-font fw-600 font-xsss" required>
                      First Name
                    </label>
              ...
              <div className="row">
                ...
                <div className="col-lg-12">
                  <a
                    href="#"
                    className="bkgrd bg-current text-center text-white font-xsss fw-600 p-3 w175 rounded-3 d-inline-block"
                  >
                    Save
                  </a>
                </div>
